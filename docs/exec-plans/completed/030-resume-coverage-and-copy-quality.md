...
- `pnpm --filter @unemployed/desktop ui:resume-workspace` passed.
...
- Replay resume quality with `pnpm --filter @unemployed/desktop benchmark:resume-quality`.
- Replay resume import with `pnpm --filter @unemployed/desktop benchmark:resume-import`.
- Replay Resume Studio UI evidence with `pnpm --filter @unemployed/desktop ui:resume-workspace`.
