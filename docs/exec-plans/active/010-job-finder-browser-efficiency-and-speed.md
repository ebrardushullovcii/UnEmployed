...
- Discovery now defers repeated search-results extraction until the end of the browser pass, deduping re-checks of the same results route before doing the expensive model-backed extraction work once.
