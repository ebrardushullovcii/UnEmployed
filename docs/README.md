...
2. [PLAN.md](PLAN.md) for the durable big-picture plan and rollout shape
3. [AGENT_CONTEXT.md](AGENT_CONTEXT.md) for skills, rules, and repo handoff conventions
4. [PRODUCT.md](PRODUCT.md) for product shape and module intent
5. [ARCHITECTURE.md](ARCHITECTURE.md) for workspace boundaries and data flow
6. [CONTRACTS.md](CONTRACTS.md) for shared schemas, adapters, and IPC rules
7. [TESTING.md](TESTING.md) for required checks and harnesses
