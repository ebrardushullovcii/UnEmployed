...
- Approved LinkedIn apply now forwards validated learned source guidance into the browser runtime, so the supported Easy Apply path can carry the same orchestrator-produced instructions without widening into unsafe generic auto-submission
