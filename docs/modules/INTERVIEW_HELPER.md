...
- Microphone permission and desktop capture source readiness are Electron-backed in rehearsal. Real microphone streams, meeting/system audio streams, local/platform STT, cloud fallback, and automatic meeting-native caption extraction still need live adapter implementation and hardware/user-permission validation.
