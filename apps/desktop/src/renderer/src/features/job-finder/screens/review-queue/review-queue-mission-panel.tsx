...
export function ReviewQueueMissionPanel({
  ...
  return (
    <section className="flex min-h-[31rem] min-w-0 flex-col gap-6 overflow-hidden rounded-[var(--radius-field)] border border-[var(--surface-panel-border)] bg-[var(--surface-panel)] px-6 py-6 xl:h-full xl:min-h-0">
