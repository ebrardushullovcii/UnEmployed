      ...
      >
        {showEmptyDiscoveryState ? (
          <div className="grid min-h-124 min-w-0 items-stretch gap-4 xl:h-full xl:min-h-0 xl:grid-cols-[minmax(23rem,25rem)_minmax(0,1fr)] xl:overflow-hidden">
            <div className="order-1 grid min-h-124 min-w-0 grid-rows-[auto_minmax(0,1fr)_auto] gap-3 xl:order-2 xl:h-full xl:min-h-0">
              <div
            ...
            <div className="order-2 min-h-0 min-w-0 xl:order-1">
              {filtersPanel}
            </div>
          </div>
        ) : (
