      ...
      <section className="surface-panel-shell relative grid gap-3.5 rounded-(--radius-field) border border-(--surface-panel-border) px-4 py-4">
        <div className="grid gap-1.5">
          ...
          <p className="text-sm leading-6 text-foreground-soft">
            Your workspace and résumé stay on this device until you choose to reset them. Reset permanently removes your profile, imported résumé, saved jobs, tailored résumés, application history, and browser session data from this device.
          </p>
        </div>
        ...
        >
          ...
          >
            <div className="grid gap-2">
              ...
              <h2 className="font-display text-xl font-semibold text-(--text-headline)" id={dialogTitleId}>
                Reset this device workspace?
              </h2>
              <p className="text-sm leading-6 text-foreground-soft">
                This permanently deletes your profile, imported résumé, saved jobs, tailored résumés, application history, and browser session data from this device. This cannot be undone.
              </p>
            </div>
