              ...
              {runOptions.length > 0 ? runOptions.map((run) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="text-[0.8rem] text-foreground-muted">{run.summary.targetsCompleted}/{run.summary.targetsPlanned} sources completed · {run.summary.validJobsFound} jobs found</span>
                  </button>
                )
              }) : (
