      ...
      {selectedJob ? (
        <>
          <div className="min-h-0 flex-1 overflow-y-auto px-6 pb-44 pt-5">
            ...
            {selectedJob.matchAssessment.reasons.length > 0 ? (
              <PreferenceList
                label="Why it fits"
            ...
            {selectedJob.matchAssessment.gaps.length > 0 ? (
              <PreferenceList
                ...
                values={selectedJob.matchAssessment.gaps}
              />
            ) : null}
            ...
            selectedJob.lastVerifiedActiveAt ? (
              <div className="grid gap-2 md:grid-cols-3">
                <div>
                  ...
                  <p className="text-(length:--text-small) leading-6 text-foreground-soft">
                    {formatOptionalDateOnly(selectedJob.firstSeenAt, 'Unknown')}
                  </p>
                </div>
                <div>
                  <p className="text-(length:--text-tiny) uppercase tracking-(--tracking-label) text-foreground-muted">
                  ...
                  <p className="text-(length:--text-small) leading-6 text-foreground-soft">
                    {formatOptionalDateOnly(selectedJob.lastSeenAt, 'Unknown')}
                  </p>
                </div>
                <div>
                  <p className="text-(length:--text-tiny) uppercase tracking-(--tracking-label) text-foreground-muted">
