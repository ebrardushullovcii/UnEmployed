...
export function ProfileOptionalSection({ children, description, title }: ProfileOptionalSectionProps) {
  return (
    <details className="surface-card-tint group rounded-(--radius-panel) border border-(--surface-panel-border) p-4 [&_summary::-webkit-details-marker]:hidden">
