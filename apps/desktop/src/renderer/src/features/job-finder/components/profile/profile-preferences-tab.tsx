    ...
    <div className="grid gap-6">
      ...
      <section className="grid content-start gap-(--gap-card)">
        <ProfileSectionHeader
          ...
          description="Use this section for the roles, locations, and companies you want Job Finder to focus on."
        />
        ...
        <article className="surface-card-tint grid gap-4 rounded-(--radius-panel) border border-(--surface-panel-border) p-4">
          ...
          <div className="grid gap-3">
            {discoveryTargets.length === 0 ? (
              <p className="text-[0.9rem] leading-6 text-foreground-soft">No job sources yet. Add the first source you want Job Finder to search.</p>
            ) : null}
