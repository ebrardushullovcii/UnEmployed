...
export function getReviewItemScrollTargetId(
  ...
  if (item.target.domain === "experience") {
    ...
    // A missing-record item has no role field to focus. Bring the empty
    // Work history section (and its Add experience action) into view instead.
    return "profile-setup-experience";
  }
