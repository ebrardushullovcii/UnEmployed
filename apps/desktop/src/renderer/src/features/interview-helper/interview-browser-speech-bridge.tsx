  ...
  function startRecognition() {
    ...
    recognition.onend = () => {
      ...
      if (enabledRef.current && listeningRef.current) {
        ...
        setStatusLabel(enabledRef.current ? 'Browser speech paused' : 'Browser speech idle')
      }
    }
    ...
    try {
      ...
      recognitionRef.current = null
      setEnabled(false)
      setStatusLabel(error instanceof Error ? error.message : 'Browser speech failed to start')
    }
  }
