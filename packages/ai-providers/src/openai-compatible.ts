    ...
    async createResumeDraft(input) {
      const payload = await fetchModelJson(
        ...
        [
          ...
          "Older or weak-fit roles may be compact, but never turn an unrelated role into a software role unless the profile record explicitly contains technical evidence.",
