...
- Keep deterministic catalog workflow orchestration here too when it applies policy on top of runtime session primitives, such as filtering, eligibility gates, checkpoint shaping, or resume-usage rules.
