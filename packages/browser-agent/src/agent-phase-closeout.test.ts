...
describe("runAgentDiscovery closeout behavior", () => {
          ...
          Promise.resolve({
            ...
            toolCalls: [
              createToolCall(
                ...
                {
                  reason:
                    "Enough evidence collected after the route stayed stable.",
                  summary:
        ...
        return Promise.resolve([
          {
            ...
            discoveryMethod: "catalog_seed",
            canonicalUrl:
              "https://www.linkedin.com/jobs/view/job_early_force_1",
            title: "Workflow Engineer",
            company: "Signal Systems",
            location: "Remote",
            workMode: ["remote"],
          ...
          toolCalls: [
            createToolCall(
              "finish",
              {
                ...
                summary:
                  "The phase needed more than one stale turn before closing.",
                reliableControls: [],
                trickyFilters: [],
                navigationTips: [
                  "Keep probing until route evidence is stronger.",
                ],
                applyTips: [],
                warnings: [],
              },
        ...
        return Promise.resolve([
          {
            ...
            discoveryMethod: "catalog_seed",
            canonicalUrl:
              "https://www.linkedin.com/jobs/view/job_not_yet_force_1",
            title: "Workflow Engineer",
            company: "Signal Systems",
            location: "Remote",
            workMode: ["remote"],
  ...
  test("delays the forced closeout prompt until after one exploratory turn", async () => {
    ...
    const countForcedCloseoutPrompts = (
